...
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/fpc_mtk_tee.ko" "/vendor/lib/modules/$GKI_PATH/fpsensor_mtk_spi.ko")
kernel_so_name_list=("fpc_mtk_tee.ko" "fpsensor_mtk_spi.ko")
